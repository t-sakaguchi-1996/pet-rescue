...
export const metadata: Metadata = {
  title: 'ANIMAL MyGO - みんなで迷子ペットを探そう',
  description:
        ...
        <AuthProvider>
          ...
          <footer className="py-8 mt-12" style={{ background: '#C46B00' }}>
            <div className="max-w-6xl mx-auto px-4 text-center">
              ...
              <p className="font-black text-white text-base mb-1">ANIMAL MyGO</p>
              <p className="text-xs" style={{ color: '#FFD98A' }}>みんなで迷子ペットを探し、協力者にもポイントが貯まるプラットフォーム</p>
              <p className="text-xs mt-4" style={{ color: '#E8A93A' }}>© 2025 ANIMAL MyGO</p>
            </div>
          </footer>
        </AuthProvider>
      </body>
